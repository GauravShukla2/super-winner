 ...
 *  
 */
package com.hybris.platform.addons.giftcheckoutaddon.jalo;
...
import com.hybris.platform.addons.giftcheckoutaddon.constants.GiftcheckoutaddonConstants;



/**
 * This is the extension manager of the Giftcheckoutaddon extension.
 */
public class GiftcheckoutaddonManager extends GeneratedGiftcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GiftcheckoutaddonManager.class.getName());
	 ...
	 */
	public static GiftcheckoutaddonManager getInstance()
	{
		return (GiftcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GiftcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GiftcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GiftcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GiftcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GiftcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
