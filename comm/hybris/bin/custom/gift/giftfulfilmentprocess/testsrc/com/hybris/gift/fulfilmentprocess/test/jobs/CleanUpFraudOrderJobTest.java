 ...
 *  
 */
package com.hybris.gift.fulfilmentprocess.test.jobs;
...
import com.hybris.gift.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GiftFulfilmentProcessConstants.ORDER_PROCESS_NAME;
