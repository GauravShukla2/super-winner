 ...
 *  
 */
package com.hybris.gift.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GiftFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GiftFulfilmentProcessConstants.PARENT_PROCESS);
