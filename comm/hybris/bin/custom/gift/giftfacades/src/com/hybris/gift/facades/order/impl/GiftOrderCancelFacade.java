package com.hybris.gift.facades.order.impl;
 ...
 *
 */
public class GiftOrderCancelFacade implements OrderCancelFacade
{

	private static final Logger LOG = Logger.getLogger(GiftOrderCancelFacade.class);
