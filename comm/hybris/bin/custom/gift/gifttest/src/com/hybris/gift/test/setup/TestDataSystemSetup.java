 ...
 *  
 */
package com.hybris.gift.test.setup;
...
import com.hybris.gift.test.constants.GiftTestConstants;
import com.hybris.gift.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GiftTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/gifttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/gifttest/import/reviews.impex");
			...
			importImpexFile(context, "/gifttest/import/cstickets.impex");
		}
	}
}
