 ...
 *  
 */
package com.hybris.gift.core.hmc;
...
/**
 * Provides necessary meta information about the giftcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class GiftCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(GiftCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.hybris.gift.core.hmc.locales";
