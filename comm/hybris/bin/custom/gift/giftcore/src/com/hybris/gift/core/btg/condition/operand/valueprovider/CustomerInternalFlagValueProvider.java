package com.hybris.gift.core.btg.condition.operand.valueprovider;
 
import com.hybris.gift.core.model.BTGCustomerInternalFlagOperandModel;
 ...
 *
 */
public abstract class CustomerInternalFlagValueProvider implements OperandValueProvider<BTGCustomerInternalFlagOperandModel>
{
