 ...
 *  
 */
package com.hybris.gift.cockpits.setup;
...
import com.hybris.gift.cockpits.constants.GiftCockpitsConstants;
 ...
 */
@SystemSetup(extension = GiftCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(GiftCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(GiftCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						GiftCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/giftcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
