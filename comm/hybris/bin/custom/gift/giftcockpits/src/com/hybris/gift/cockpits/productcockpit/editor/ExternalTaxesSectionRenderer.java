 ...
 *  
 */
package com.hybris.gift.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("giftcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("giftcockpits.product.externalTaxes"));
