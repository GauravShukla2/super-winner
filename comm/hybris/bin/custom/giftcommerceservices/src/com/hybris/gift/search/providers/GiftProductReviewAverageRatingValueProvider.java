package com.hybris.gift.search.providers;
...
public class GiftProductReviewAverageRatingValueProvider extends ProductReviewAverageRatingValueProvider
{
    private static final Logger LOG = Logger.getLogger(GiftProductReviewAverageRatingValueProvider.class);
    @Override
